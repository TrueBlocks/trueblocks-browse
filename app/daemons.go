...
func (a *App) startDaemons() {
	initFreshener := func() bool {
		...
		if a.daemons.FreshenController = types.NewFreshen(a, "freshen", freshenRate, a.GetDaemonOn("freshen")); a.daemons.FreshenController == nil {
	...
	initScraper := func() bool {
		if a.daemons.ScraperController = types.NewScraper(a, "scraper", 7000, a.GetDaemonOn("scraper")); a.daemons.ScraperController == nil {
	...
	initIpfs := func() bool {
		if a.daemons.IpfsController = types.NewIpfs(a, "ipfs", 10000, a.GetDaemonOn("ipfs")); a.daemons.IpfsController == nil {
