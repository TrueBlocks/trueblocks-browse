...
import { View, FormTable, DataTable, FieldGroup, ViewForm, CleanButton, AddButton } from "@components";
...
export const MonitorsView = () => {
  ...
  const forms: ViewForm = {
    monitors: <FormTable data={monitors} groups={createMonitorForm(table)} />,
  };
  return (
    <ViewStateProvider
      route={route}
